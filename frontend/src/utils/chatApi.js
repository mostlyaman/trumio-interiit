...
import { default as reduxStore } from "../store/chat/store.js";
import { setUserIsLoggedIn } from "../store/chat/UserIsLoggedIn .js";
import { updateNetworkState } from "../store/chat/NetworkState.js";
...
const api = new Api(process.env.NEXT_PUBLIC_SOCKET_CONNECT);
api.connect();
